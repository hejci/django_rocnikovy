"""
Django settings for rocnikovy project.
...
SECRET_KEY = 'django-insecure-83rvnw7xxb=wx^88iwciq8#)aj$gf@p@92(2n$xo6+4w!6&d^r'
...
WSGI_APPLICATION = 'rocnikovy.wsgi.application'
